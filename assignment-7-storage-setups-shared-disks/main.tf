# ============================================
# Assignment 7: Storage Setups with Shared Disks and Backup
# Creates: Resource Group, VNet, Subnet, 2 VMs with Shared Data Disks, Load Balancer, Recovery Services Vault with Backup Policy
...
terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "assignment-7-storage.tfstate"
  }
}
...
# ============================================
# Step 7: Connect NICs to Backend Pool
# ============================================
...
# ============================================
# Extra: Network Security Group to allow Load Balancer Health Probe
# ============================================
